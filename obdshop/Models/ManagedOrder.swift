...
class ManagedOrder: NSManagedObject
{
  /*func toOrder() -> Order
  {
    ...
    return Order(firstName: firstName!, lastName: lastName!, phone: phone!, email: email!, billingAddress: billingAddress, paymentMethod: paymentMethod, shipmentAddress: shipmentAddress, shipmentMethod: shipmentMethod, id: id, date: date!, total: total!) x
  }           */
